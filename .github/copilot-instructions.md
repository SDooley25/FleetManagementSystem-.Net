...
## Testing Preferences
- Use NUnit for unit tests in the FleetManagementSystem-.Net.UnitTests project instead of MSTest/xUnit, matching the user's testing preference for this workspace.